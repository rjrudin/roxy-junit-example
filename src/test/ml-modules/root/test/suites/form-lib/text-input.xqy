...
return (
  (: Broken on purpose :)
  test:assert-equal("input-labellll", $input/html:label/fn:string()),
  test:assert-equal("input-nameee", $input/html:input/@name/fn:string()),
  test:assert-equal("input-classsss", $input/@class/fn:string()),
